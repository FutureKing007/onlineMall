...
app.controller('itemCatController', function($scope, $controller, baseService){
    ...
    $scope.findTypeIdAndNameList = function () {
        baseService.sendGet("/typeTemplate/findTypeIdAndNameList").then(function (response) {
            $scope.typeIdAndNameList = response.data
        })
    };
});